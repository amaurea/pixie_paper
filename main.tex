...
\maketitle
\begin{abstract}
	We develop a time-ordered data simulator and mapmaker for the
	...
	elliptical beams, subpixel effects, correlated noise and
...
the mapmaker itself can ignore it, and set $\vec s^\textrm{sky}_B=0$.
...
The full source code of the mapmaker can be found in the
...
and mapmaker on noiseless, ideal data. Figure~\ref{fig:tod} shows
