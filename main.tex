...
can interpolate via Fourier shifting: Given an array $a$ of samples of length $N$ and a discrete Fourier transform $F$,
...
This spin-2 scan drift correction is identical to the one bove, but with
