...
\begin{figure}
	...
	\end{tabular}
	\caption{Polariziation leakage from elliptical beams, and how it's cancelled in PIXIE.
	We simulated sky observations with an elliptical beam with an elongation of
	0.95 for Lx and Rx detectors
	and 1.05 for Ly and Ry detectors. This 10\% beam mismatch between detectors in the
	same horn is not expected, but is included to show the multiple ways in which
	leakage is suppressed. \emph{Top}: Q and U maps based on only the Lx detector.
...
\begin{figure}
	...
	the first cancelation only 90\% efficient.}
\end{figure}
